...
void BackgroundRenderer::InitializeGlContent(AAssetManager* asset_manager,
  ...
  camera_program_ =
      utils::CreateProgram(kCameraVertexShaderFilename,
  ...
  if (!utils::LoadPngFromAssetManager(GL_TEXTURE_2D,
  ...
  depth_program_ = utils::CreateProgram(kDepthVisualizerVertexShaderFilename,
